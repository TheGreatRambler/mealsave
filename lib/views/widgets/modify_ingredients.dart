  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Form(
            key: formKey,
            child: Consumer<CurrentState>(builder: (context, currentState, child) {
              return Column(
                children: <Widget>[
                  Expanded(
                      ...
                      return GestureDetector(
                          ...
                          child: currentState.ingredient(index).showEditView
                              ? Column(children: [
                                  Container(
                                      ...
                                      child: Column(
                                          ...
                                          children: [
                                            TextFormField(
                                              initialValue: currentState.ingredient(index).name,
                                              keyboardType: TextInputType.text,
                                              style: const TextStyle(color: Colors.black),
                                              decoration: currentState.getTextInputDecoration(context, "Name"),
                                              validator: (value) {
                                              ...
                                              onFieldSubmitted: (value) {
                                                setState(() {
                                                  currentState.ingredient(index).name = value;
                                              ...
                                              children: [
                                                Expanded(
                                                  child: DropdownButtonFormField<VolumeType>(
                                                    ...
                                                    decoration:
                                                        currentState.getDropdownDecoration(context, "Quantity Type"),
                                                    value: currentState.ingredient(index).volumeType,
                                                    ...
                                                    items: VolumeType.values
                                                        .where((value) => value != VolumeType.percentage)
                                                        .map<DropdownMenuItem<VolumeType>>((VolumeType value) {
                                                ...
                                                Expanded(
                                                  child: TextFormField(
                                                    ...
                                                    key: Key(currentState.ingredient(index).volumeQuantity.toString()),
                                                    initialValue: currentState.ingredient(index).volumeQuantity == 0.0
                                                        ? null
                                                        : currentState
                                                            .ingredient(index)
                                                            .volumeQuantity
                                                    ...
                                                    decoration: currentState.getTextInputDecoration(context,
                                                        currentState.ingredient(index).volumeType.getProperLabel()),
                                                    validator: (value) {
                                                      if (value == null ||
                                                          value.isEmpty ||
                                                    ...
                                                    onTap: () async {
                                                      var returnedValue = await openNumberDialog(
                                                          ...
                                                          0,
                                                          4294967295,
                                                          currentState.ingredient(index).volumeQuantity,
                                                          Text(currentState
                                                              .ingredient(index)
                                                              .volumeType
                                                              .getProperLabel()));
                                                      ...
                                                      if (returnedValue != null) {
                                                        setState(() {
                                                          currentState.ingredient(index).volumeQuantity = returnedValue;
                                                          currentState.modifyIngredient(currentState.ingredient(index));
                                                        });
                                                      }
                                                    },
                                            ...
                                            TextFormField(
                                              key: Key(currentState.ingredient(index).price.toString()),
                                              initialValue: currentState.ingredient(index).price == 0
                                                  ? null
                                                  : Money.fromInt(currentState.ingredient(index).price, code: "USD")
                                                      .format("#.00S"),
                                              readOnly: true,
                                              style: const TextStyle(color: Colors.black),
                                              decoration: currentState.getTextInputDecoration(context, "Price"),
                                              onTap: () async {
                                                var returnedValue = await openNumberDialog(context, 0, 4294967295,
                                                    currentState.ingredient(index).price / 100.0, const Text("Price"));

                                                if (returnedValue != null) {
                                                  setState(() {
                                                    currentState.ingredient(index).price =
                                                        (returnedValue * 100.0).floor();
                                                    currentState.modifyIngredient(currentState.ingredient(index));
                                                  });
                                                }
                                              },
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                Expanded(
                                                  ...
                                                  onPressed: () async {
                                                    setState(() {
                                                      currentState.ingredient(index).showEditView = false;
                                                    });
                                                  },
                                            ...
                                            ElevatedButton(
                                              style: ElevatedButton.styleFrom(
                                                  ...
                                                  minimumSize: const Size.fromHeight(60)),
                                              onPressed: () async {
                                                if (currentState.canRemoveIngredient(currentState.ingredient(index))) {
                                                  await currentState.removeIngredient(currentState.ingredient(index));
                                                } else {
                                                  await showDialog<String>(
                                                    context: context,
                                                    builder: (BuildContext context) => AlertDialog(
                                                      title: const Text("Cannot remove ingredient"),
                                                      content: const Text(
                              ...
                              : Dismissible(
                                  ...
                                  direction: currentState.canRemoveIngredient(currentState.ingredient(index))
                                  ...
                                  child: Container(
                                    ...
                                    height: 60,
                                    child: Center(
                                        child: Text(currentState.ingredient(index).name,
                  ...
                  Row(
                    children: [
                      ...
                      const SizedBox(width: 8.0),
                      Expanded(child: Consumer<CurrentState>(builder: (context, currentState, child) {
